...
namespace TeduCoreApp.Api.Controllers
{
    ...
    [ApiController]
    public class ApiPublishersController : ControllerBase
    {
        private readonly AppDbContext _context;

        public ApiPublishersController(AppDbContext context)
        {
            _context = context;
        }

        // GET: api/ApiPublishers
        [HttpGet]
